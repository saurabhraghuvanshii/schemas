...
Browse the full Meshery REST API — interactive endpoint documentation powered by [ReDoc](https://github.com/Redocly/redoc), generated from the bundled OpenAPI specifications in this repository.
...
You can then open these files in any OpenAPI viewer or use ReDoc CLI:

```bash
npx @redocly/cli preview-docs _openapi_build/meshery_openapi.yml
```
