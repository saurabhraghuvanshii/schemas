...
// Valid indicates whether the value is a known member of the ComponentDefinitionFormat enum.
func (e ComponentDefinitionFormat) Valid() bool {
	switch e {
	case CUE:
		return true
	case JSON:
...
// Valid indicates whether the value is a known member of the ComponentDefinitionStatus enum.
func (e ComponentDefinitionStatus) Valid() bool {
	switch e {
	case Duplicate:
		return true
	case Enabled:
