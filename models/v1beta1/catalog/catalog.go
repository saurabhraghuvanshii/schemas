...
// Valid indicates whether the value is a known member of the CatalogDataCompatibility enum.
func (e CatalogDataCompatibility) Valid() bool {
	switch e {
	case Kubernetes:
		return true
	default:
...
// Valid indicates whether the value is a known member of the CatalogDataType enum.
func (e CatalogDataType) Valid() bool {
	switch e {
	case Deployment:
		return true
	case Observability:
