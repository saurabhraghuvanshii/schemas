...
func (e ImportRequestUploadType) Valid() bool {
	switch e {
	case Csv:
		return true
	case File:
...
// Valid indicates whether the value is a known member of the ModelDefinitionStatus enum.
func (e ModelDefinitionStatus) Valid() bool {
	switch e {
	case Duplicate:
		return true
	case Enabled:
