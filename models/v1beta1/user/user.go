...
// Valid indicates whether the value is a known member of the UserRoleNames enum.
func (e UserRoleNames) Valid() bool {
	switch e {
	case UserRoleNamesAdmin:
		return true
	case UserRoleNamesCurator:
		return true
	case UserRoleNamesMeshmap:
		return true
	case UserRoleNamesOrganizationAdmin:
		return true
	case UserRoleNamesTeamAdmin:
		return true
	case UserRoleNamesUser:
		return true
	case UserRoleNamesWorkspaceAdmin:
		return true
	case UserRoleNamesWorkspaceManager:
		return true
	default:
		return false
	}
