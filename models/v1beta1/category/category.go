...
// Valid indicates whether the value is a known member of the CategoryDefinitionName enum.
func (e CategoryDefinitionName) Valid() bool {
	switch e {
	case Analytics:
		return true
	case AppDefinitionAndDevelopment:
		return true
	case CloudNativeNetwork:
		return true
	...
	case MachineLearning:
		return true
	case ObservabilityAndAnalysis:
		return true
	case OrchestrationManagement:
		return true
	case Platform:
		return true
	case Provisioning:
